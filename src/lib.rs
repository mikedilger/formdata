...
// Uploaded File and it's serialization code is generated by the build.rs script.
// This allows serde to work w/o requiring unstable rust features.
// See https://github.com/serde-rs/serde
include!(concat!(env!("OUT_DIR"), "/uploaded_file.rs"));
...
// FormData and it's serialization code is generated by the build.rs script.
// This allows serde to work w/o requiring unstable rust features.
// See https://github.com/serde-rs/serde
include!(concat!(env!("OUT_DIR"), "/form_data.rs"));
